...
void VulkanApp::createCommandPool() {
    QueueFamilyIndices queueFamilyIndices = getDeviceQueueFamilies(physicalDevice);
...
void VulkanApp::setFramebufferResized(bool resized) {
